...
describe('MembershipLimitsService', () => {
  ...
  describe('getCurrentMonthLimits', () => {
    ...
    it('should return spirit plan limits', async () => {
      await pool.query(`UPDATE memberships SET plan_type = 'spirit' WHERE id = $1`, [
        testMembership.id,
      ])
  ...
  describe('recordEmergencyUse', () => {
    ...
    it('should throw when no active membership', async () => {
      ...
      await expect(MembershipLimitsService.recordEmergencyUse(testUser.id)).rejects.toThrow(
  ...
  describe('resetUserMonthlyLimits', () => {
    ...
    it('should throw when no active membership', async () => {
      ...
      await expect(MembershipLimitsService.resetUserMonthlyLimits(testUser.id)).rejects.toThrow(
        'No active membership'
      )
    })
  })
