...
import { getActiveLoan, getLoanHistory, loanPowerbank, returnPowerbank } from '../services/powerbankService.js'
import { useEmergencyArticle, getEmergencyHistory } from '../services/emergencyService.js'
...
export const requestEmergencyArticle = async (req, res) => {
  try {
    ...
    const usage = await useEmergencyArticle(userId, articleType, commerceId, commerceName)
